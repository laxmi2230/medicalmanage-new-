    ...
    <div class="tabbed_area">  
		...
		*/
        ...
        while($row = mysqli_fetch_array( $result )) {
				...
				?>
				<td><a href="update_manager.php?username=<?php echo $row['username']?>"><img src="images/update.jpeg" width="35" height="35" border="0" /></a></td>
			<td><a href="delete_manager.php?manager_id=<?php echo $row['manager_id']?>"><img src="images/delete.jpeg" width="35" height="35" border="0" /></a></td>
				<?php
		 } 
        // close table>
        echo "</table>";
