...
<h1 style="font-size:73px;"><font color="black"><a href="#"><img src="shop.jpg"></a><b><u>DRUG MART</u></b></h1></font></div>
    ...
    <div class="tabbed_area">  
		...
		*/
        ...
        while($row = mysqli_fetch_array( $result )) {
				...
				?>
				<td><a href="update_cashier.php?username=<?php echo $row['username']?>"><img src="images/update.jpeg" width="35" height="35" border="0" /></a></td>
				<td><a href="delete_cashier.php?cashier_id=<?php echo $row['cashier_id']?>"><img src="images/delete.jpeg" width="35" height="35" border="0" /></a></td>
				<?php
		 } 
        // close table>
        echo "</table>";
